...
# renv will write to files within the active project folder
# - A folder 'renv' in the project directory, and
# - A lockfile called 'renv.lock' in the project directory.
# Finally, renv maintains a local cache of data on the filesystem, located at: - "~/Library/Caches/org.R-project.R/R/renv"
...
output_dir <- '/Users/marcelo/Downloads/Plot2Publish UOW R Course/spacewalk-analysis/results/figures/'

df <- fromJSON("/Users/marcelo/Downloads/Plot2Publish UOW R Course/analysis/data.json", flatten = TRUE)
...
ggsave("/Users/marcelo/Downloads/Plot2Publish UOW R Course/spacewalk-analysis/results/figures/fig_evas_per_year.png", plot = p1,
...
ggsave("/Users/marcelo/Downloads/Plot2Publish UOW R Course/spacewalk-analysis/results/figures/fig_cumulative_count.png", plot = p2,
       width = 8, height = 4, dpi = 150)
...
ggsave("/Users/marcelo/Downloads/Plot2Publish UOW R Course/spacewalk-analysis/results/figures/fig_duration_over_time.png", plot = p3,
       width = 8, height = 4, dpi = 150)
